from PyQt5.QtWidgets import QWidget, QVBoxLayout, QPushButton, QTextEdit, QApplication, QHBoxLayout, QDialog, QSlider, QLabel, QGraphicsDropShadowEffect, QFrame
...
class SimpleApp(QWidget):
    ...
    def initUI(self):
        ...
        button_frame = QFrame(self)  # Здесь создаем button_frame
        button_frame.setStyleSheet("QFrame { border: 2px solid #A77BCA; border-radius: 10px; padding: 10px; }")
        ...
        layout.addWidget(button_frame)  # Добавляем рамку с кнопками в основной layout
    ...
    def set_theme(self):
        ...
        # Обновляем стиль текстового поля с новым размером шрифта self.text_output.setStyleSheet(f"border: 1px solid #BBBBBB; padding: 10px; font-size: {self.font_size}px;")
    ...
    def update_font_size(self, value):
        ...
        self.set_theme()  # Обновляем тему, чтобы применить новый размер шрифта # Обновляем стиль текстового поля с новым размером шрифта
        self.text_output.setStyleSheet(f"border: 1px solid #BBBBBB; padding: 10px; font-size: {self.font_size}px;")
